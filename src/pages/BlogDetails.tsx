...
const BlogDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9]">
      <Seo
        title={`${blog.title} | Blog | Ariful Creator Studio`}
        description={blog.metaDescription}
        keywords={blog.tags.join(', ') + ', blog, portfolio, graphic design, logo design, branding, UI/UX, Bangladesh, Ariful Creator Studio, arifulcreatorstudio'}
        image={blog.image}
      />
      <Navbar />
      <main>
